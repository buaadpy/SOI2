...
var MapManage = function (scene) {
    ...
    this.island = null;//连接岛屿
}

//创造地图
MapManage.prototype.createMap = function () {
    //加载天空盒
    var skybox = BABYLON.Mesh.CreateBox('skyBox', 1600.0, this.gamescene);
    ...
    var ground = BABYLON.Mesh.CreateGroundFromHeightMap('ground', '../asset/image/map/island_height.jpg', 1000, 1000, 200, 0, 35, this.gamescene, false);
    ground.material = groundMaterial;
    this.island = ground;
    //加载水
    var waterMesh = BABYLON.Mesh.CreateGround('waterMesh', 1600, 1600, 1, this.gamescene, false);
